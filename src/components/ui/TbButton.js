...
export const TbButton = ({ children, variant = 'primary', className = '', ...props }) => (_jsx("button", { className: `inline-flex items-center justify-center gap-2 font-syne font-bold text-sm uppercase tracking-wider
                px-6 py-3 transition-all duration-200
                focus:outline-none focus:ring-2 focus:ring-tb-sienna
                disabled:opacity-50 disabled:cursor-not-allowed
                ${variantMap[variant]} ${className}`, ...props, children: children }));
